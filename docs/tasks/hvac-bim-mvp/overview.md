...
- [x] [TASK-0042: プリセットデータ作成（5段階）+ 読込UI](TASK-0042.md) - 8h (DIRECT) 🔵
- [ ] [TASK-0043: 保存/復元検証 — HVACノードのIndexedDB永続化](TASK-0043.md) - 8h (TDD) 🔵
- [x] [TASK-0044: 画面表示仕様 — ゾーンカラー、ダクトラベル、配管色分け統合](TASK-0044.md) - 8h (TDD) 🔵
- [x] [TASK-0045: 操作フィードバック統合 — 風量一斉更新、トースト通知等](TASK-0045.md) - 8h (TDD) 🔵
- [x] [TASK-0046: デモシナリオ検証 — ワンパス通し確認 + 最終調整](TASK-0046.md) - 8h (TDD) 🔵
